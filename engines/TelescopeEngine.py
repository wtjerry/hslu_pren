...
class TelescopeEngine(object):
    ...
    def up(self, mm):
        ...
        self._communication.execute_multiple_return(self._UP_COMMAND + str(mm_formatted), self._set_z)

    def down(self, mm):
        mm_formatted = self._get_formatted_mm(mm)
        self._communication.execute_multiple_return(self._DOWN_COMMAND + str(mm_formatted), self._set_z)
