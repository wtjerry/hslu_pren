class Config:
    BINDING_USE_REAL_MOVEMENT = False
    BINDING_USE_REAL_GOAL_DETECTION = False
    BINDING_USE_REAL_MAGNET = False
    BINDING_USE_REAL_TELESCOPE = False
    BINDING_USE_REAL_POSITION = False
    BINDING_USE_REAL_BALANCER = False
    BINDING_USE_REAL_LOAD_POSITION_COMPARER = False
    BINDING_USE_REAL_TILT_ENGINE = False

    CONTROLLER_MOVE_TO_LOAD_SPEED = 4
    ...
    CONTROLLER_DISTANCE_TO_GOAL_STOP = -50
    CONTROLLER_DISTANCE_TO_GOAL_SLOWER = 100
    CONTROLLER_INITIAL_LOAD_HEIGHT = 300
    ...
    CONTROLLER_DISTANCE_CAMERA_TELESCOPE = 25

    COMPARER_LOAD_POSITION = 580

    POSITION_TELESCOPE_HEIGHT = 150
    POSITION_START_X_POS = 275
