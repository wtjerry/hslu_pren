class Config:
    ...
    CONTROLLER_INITIAL_TELESCOPE_DOWN = 205 
    CONTROLLER_INITIAL_TELESCOPE_UP = 205 
    ...
    CONTROLLER_X_POSITION_WHERE_GOAL_DETECTION_CORRECTION_IS_MIN = 800
    CONTROLLER_X_POSITION_WHERE_GOAL_DETECTION_CORRECTION_IS_MAX = 3500
    CONTROLLER_MIN_GOAL_DETECTION_CORRECTION = -50
    CONTROLLER_MAX_GOAL_DETECTION_CORRECTION = 20
    CONTROLLER_CORRECTION_INTERCEPT = CONTROLLER_MIN_GOAL_DETECTION_CORRECTION

    COMPARER_LOAD_POSITION = 600
