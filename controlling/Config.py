class Config:
    ...
    CONTROLLER_INITIAL_TELESCOPE_DOWN = 190 
    CONTROLLER_INITIAL_TELESCOPE_UP = 180 
    CONTROLLER_END_TELESCOPE_HEIGHT = 200
    CONTROLLER_END_SPEED = 2
    CONTROLLER_END_PARCOURS_POSITION = 4200
    CONTROLLER_END_SLOW_DOWN_POSITION = 3250
    CONTROLLER_DISTANCE_CAMERA_TELESCOPE = 310
