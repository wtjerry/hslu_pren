...
class Binding:
    ...
    def __init__(self):
        ...
        self.target_detection = Dummy() if self._use_real_goal_detection else DummyTargetDetection()
        ...
        self.position = self._get_real_position() if self._use_real_position \
