...
class Binding:
    ...
    def __init__(self, executor, start, goalfound):
        ...
        self.goal_detection = Dummy() if self.use_real_goal_detection else DummyGoalDetection(goalfound)
        ...
        self.start_signal_receiver = StartSignalReceiver(executor, start) if self.use_real_start_signal \
            else DummyStartSignalReceiver(executor, start)
